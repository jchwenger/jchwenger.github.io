...
*Werewords* ([extracts](https://www.instagram.com/p/DRS1iFrDF26)), 2024-. Constrained writing based on common letter patterns between two words.

[*Cubes*](https://thenewriverjournal.org/cubes-by-jeremie-wenger/), 2024-. Constrained writing on cubic surfaces, using *Squares*.

[*Subwords*](https://www.instagram.com/p/DL6-sMDoFvy), 2023-4. Constrained writing based on subsequence decompositions of long words into shorter ones.

*Squares* ([extracts](https://www.pamenarpress.com/post/j%C3%A9r%C3%A9mie-wenger)), 2022-. Constrained writing based on algorithmically generated word squares.

[*Chains*](https://www.tiltedhouse.org/tilt0005-j), 2022-3. Garlands of (mostly) cliché phrases.
...
*Lacanage* ([extracts](https://stringsmag.com/strings-2-jeremie-wenger)), 2021. Neural texts using materials from a language model finetuned on Jacques Lacan and my own texts.

*Inanimaux* ("Inanimals") ([readings (in French)](https://www.youtube.com/playlist?list=PLlNDOBNFozLAx8WbcpEHnpZuQeGwohLaI)), 2020. Neural texts generated using materials generated by language models finetuned on French.

[*CHATBOT*](chatbot), 2020-1. Act and dialogue with a conversational agent-actor.

[*Artificial It*](posts/artificial-it), 2018-9. Neural texts using materials from 'doppelgänger' LSTM models, trained on my own texts.
...
*AIT (Artificial It)*, 2018. Steps toward Neural Text Generation, using materials from 'doppelgänger' LSTM models, trained on my own texts. LSTMs/Python [forthcoming publication in gorse[\*](http://gorse.ie/)]
