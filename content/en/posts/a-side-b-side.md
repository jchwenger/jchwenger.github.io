...
title: "*Squares* & *Chains* @ A-Side | B-Side, 2023"
translationKey:
...
{{< gallery id="rosser" caption="*Photographs: Thomas Rosser.*" cols=1 >}}

{{< separators type="blank" >}}

{{< gallery id="wenger" caption="*Photographs: Jérémie Wenger.*" cols=2 >}}
